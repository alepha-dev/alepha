...
| band                        | owner                                                                                                                                                                                                                                                                |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `3300-3399`                 | **dev servers** — `dev.port` in each app's `alepha.config.ts` (docs 3302, lore 3303, examples/shop 3305, examples/totp 3307, ui 3308, examples/ssr 3311), plus `@alepha/devtools`'s own Vite config (3310), which is not an Alepha app and has no `alepha.config.ts` |

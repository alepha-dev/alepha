  ...
  en = $dictionary({
    lazy: async () => ({
      default: {
        ...
        "campaign.menu.beacons": "Beacons",

        "beacons.title": "Beacons",
        "beacons.empty": "No beacons yet.",
        "beacons.empty.new":
          "No new beacons. Reports submitted via the embedded widget will appear here.",
        "beacons.empty.status": "No $1 beacons.",
        "beacons.filter.new": "New",
        "beacons.filter.promoted": "Promoted",
        "beacons.filter.discarded": "Discarded",
        "beacons.filter.all": "All",
        "beacons.promote": "Promote to Quest",
        "beacons.discard": "Discard",
        "beacons.discarded": "Beacon discarded",
        "beacons.discardError": "Failed to discard beacon",
        "beacons.delete": "Delete",
        "beacons.deleted": "Beacon deleted",
        "beacons.deleteError": "Failed to delete beacon",
        "beacons.deleteConfirm": "Delete this beacon? This cannot be undone.",
        "beacons.promoted": "Promoted to quest #$1",
        "beacons.promotedToast": "Promoted to quest",
        "beacons.promoteError": "Failed to promote beacon",
        "beacons.viewQuest": "View quest",
        "beacons.report.bug": "Bug",
        "beacons.report.feature": "Feature",
        "beacons.context.title": "Context",
        "beacons.context.url": "URL",
        "beacons.context.path": "Path",
        "beacons.context.userAgent": "User agent",
        "beacons.context.viewport": "Viewport",
        "beacons.context.locale": "Locale",
        "beacons.context.referrer": "Referrer",
        "beacons.context.reporter": "Reporter",
        "beacons.anonymous": "anonymous",
        "beacons.description": "Description",
        "beacons.screenshot": "Screenshot",
        "beacons.settings.title": "Beacons",
        "beacons.settings.enable": "Enable beacons widget",
        "beacons.settings.enableHelp":
          "Let users on your sites submit bug and feature reports.",
        "beacons.settings.snippet": "Embed snippet",
        "beacons.settings.snippetHelp":
          "Paste this into the <head> of any allowed origin.",
        "beacons.settings.token": "Public token",
        "beacons.settings.regenerate": "Regenerate",
        "beacons.settings.regenerateWarning":
          "Regenerating invalidates any existing snippet using the old token.",
        "beacons.settings.regenerated": "Token regenerated",
        "beacons.settings.regenerateError": "Failed to regenerate token",
        "beacons.settings.allowedOrigins": "Allowed origins",
        "beacons.settings.allowedOriginsHelp":
          "One per line. Wildcards like *.example.com match the domain and all sub-domains.",
        "beacons.settings.rateLimit": "Rate limit (per minute, per IP)",
        "beacons.settings.rateLimitHelp":
          "Between 1 and 60 requests per minute. Default $1.",
        "beacons.settings.saveError": "Failed to save beacon settings",
        "beacons.settings.copyError": "Could not copy to clipboard",
        "beacons.promoteForm.title": "Promote to Quest",
        "beacons.promoteForm.questTitle": "Title",
        "beacons.promoteForm.description": "Description",
        "beacons.promoteForm.zone": "Zone",
        "beacons.promoteForm.zonePlaceholder": "Select a zone",
        "beacons.promoteForm.noZones": "No zones configured",
        "beacons.promoteForm.priority": "Priority",
        "beacons.promoteForm.priorityOptional": "Optional",
        "beacons.promoteForm.priorityLow": "Low",
        "beacons.promoteForm.priorityMedium": "Medium",
        "beacons.promoteForm.priorityHigh": "High",
        "beacons.promoteForm.difficulty": "Difficulty",
        "beacons.promoteForm.submit": "Promote",
        "beacons.promoteForm.cancel": "Cancel",
      },
    }),
  });
  fr = $dictionary({
    lazy: async () => ({
      default: {
        ...
        "campaign.menu.beacons": "Balises",

        "beacons.title": "Balises",
        "beacons.empty": "Aucune balise pour le moment.",
        "beacons.empty.new":
          "Aucune nouvelle balise. Les rapports envoyés via le widget embarqué apparaîtront ici.",
        "beacons.empty.status": "Aucune balise $1.",
        "beacons.filter.new": "Nouvelles",
        "beacons.filter.promoted": "Promues",
        "beacons.filter.discarded": "Rejetées",
        "beacons.filter.all": "Toutes",
        "beacons.promote": "Promouvoir en quête",
        "beacons.discard": "Rejeter",
        "beacons.discarded": "Balise rejetée",
        "beacons.discardError": "Échec du rejet de la balise",
        "beacons.delete": "Supprimer",
        "beacons.deleted": "Balise supprimée",
        "beacons.deleteError": "Échec de la suppression de la balise",
        "beacons.deleteConfirm":
          "Supprimer cette balise ? Cette action est irréversible.",
        "beacons.promoted": "Promue en quête #$1",
        "beacons.promotedToast": "Promue en quête",
        "beacons.promoteError": "Échec de la promotion de la balise",
        "beacons.viewQuest": "Voir la quête",
        "beacons.report.bug": "Bogue",
        "beacons.report.feature": "Fonctionnalité",
        "beacons.context.title": "Contexte",
        "beacons.context.url": "URL",
        "beacons.context.path": "Chemin",
        "beacons.context.userAgent": "Agent utilisateur",
        "beacons.context.viewport": "Fenêtre",
        "beacons.context.locale": "Locale",
        "beacons.context.referrer": "Référent",
        "beacons.context.reporter": "Auteur",
        "beacons.anonymous": "anonyme",
        "beacons.description": "Description",
        "beacons.screenshot": "Capture d'écran",
        "beacons.settings.title": "Balises",
        "beacons.settings.enable": "Activer le widget de balises",
        "beacons.settings.enableHelp":
          "Permettez aux utilisateurs de vos sites d'envoyer des rapports de bogues et des demandes de fonctionnalités.",
        "beacons.settings.snippet": "Code à intégrer",
        "beacons.settings.snippetHelp":
          "Collez ce code dans le <head> de toute origine autorisée.",
        "beacons.settings.token": "Jeton public",
        "beacons.settings.regenerate": "Régénérer",
        "beacons.settings.regenerateWarning":
          "La régénération invalide tout code utilisant l'ancien jeton.",
        "beacons.settings.regenerated": "Jeton régénéré",
        "beacons.settings.regenerateError": "Échec de la régénération du jeton",
        "beacons.settings.allowedOrigins": "Origines autorisées",
        "beacons.settings.allowedOriginsHelp":
          "Une par ligne. Les jokers comme *.example.com couvrent le domaine et tous ses sous-domaines.",
        "beacons.settings.rateLimit": "Limite (par minute, par IP)",
        "beacons.settings.rateLimitHelp":
          "Entre 1 et 60 requêtes par minute. Par défaut $1.",
        "beacons.settings.saveError":
          "Échec de la sauvegarde des paramètres de balise",
        "beacons.settings.copyError":
          "Impossible de copier dans le presse-papier",
        "beacons.promoteForm.title": "Promouvoir en quête",
        "beacons.promoteForm.questTitle": "Titre",
        "beacons.promoteForm.description": "Description",
        "beacons.promoteForm.zone": "Zone",
        "beacons.promoteForm.zonePlaceholder": "Choisir une zone",
        "beacons.promoteForm.noZones": "Aucune zone configurée",
        "beacons.promoteForm.priority": "Priorité",
        "beacons.promoteForm.priorityOptional": "Optionnelle",
        "beacons.promoteForm.priorityLow": "Faible",
        "beacons.promoteForm.priorityMedium": "Normale",
        "beacons.promoteForm.priorityHigh": "Haute",
        "beacons.promoteForm.difficulty": "Difficulté",
        "beacons.promoteForm.submit": "Promouvoir",
        "beacons.promoteForm.cancel": "Annuler",
      },
    }),
  });
}

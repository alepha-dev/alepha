...
describe("CampaignController leaveCampaign", () => {
  ...
  it("removes the member's character so the campaign drops out of getMyCampaigns", async ({
    ...
    // invitations, which is more plumbing than this test needs.
    // biome-ignore lint/suspicious/noExplicitAny: reach into the controller's
    // repository to seed a non-owner character without invitation glue.

...
Nobody has started this epic yet (it is a \`draft\` or \`ready\`), which means its plan is open and its quest set can still change. Your job is to make it a plan worth executing:

...
const ProjectQuestLogRail = (props: ProjectQuestLogRailProps): ReactElement => {
  ...
  return (
    <button
      ...
      // the tile to fit 32px. `hover:bg-hover` still works under it: the
      // lattice is a `z-index: -1` pseudo, so it sits above the button's own
      // background and below its icons.
      className="lore-quest-log-facets lore-quest-log-facets-rail border-border text-muted-foreground hover:text-foreground hover:bg-hover flex w-8 flex-none flex-col items-center gap-2 border-r pt-3 transition-colors"
    >

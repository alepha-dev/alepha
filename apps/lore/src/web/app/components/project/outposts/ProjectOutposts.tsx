...
export interface ProjectOutpostsProps {
...
/**
 * The machines reporting into this project, and whether they still are.
 *
 * Read-only by construction: Lore never reaches a machine, so there is nothing
 * here to press. Enrolment, rotation and deletion all live in project
 ...
 */
const ProjectOutposts = (props: ProjectOutpostsProps) => {
...
export default ProjectOutposts;

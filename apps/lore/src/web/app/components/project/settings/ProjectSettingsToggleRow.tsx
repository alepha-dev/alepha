...
import type { FeatureToggle } from "./useProjectFeatureToggle.ts";

export interface ProjectSettingsToggleRowProps {
  title: string;
  description: string;
 ...
 */
const ProjectSettingsToggleRow = (props: ProjectSettingsToggleRowProps) => {
  return (
...
export default ProjectSettingsToggleRow;

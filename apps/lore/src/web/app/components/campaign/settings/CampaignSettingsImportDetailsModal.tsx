...
export interface CampaignSettingsImportDetailsModalProps {
  open: boolean;
...
const CampaignSettingsImportDetailsModal = (
  props: CampaignSettingsImportDetailsModalProps,
) => {
  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className="max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {tr("campaign.settings.data.import.details")}
          </DialogTitle>
          <DialogDescription>
...
export default CampaignSettingsImportDetailsModal;

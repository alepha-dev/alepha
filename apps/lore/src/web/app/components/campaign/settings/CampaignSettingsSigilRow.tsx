...
export interface CampaignSettingsSigilRowProps {
  sigil: SigilResource;
 ...
 */
const CampaignSettingsSigilRow = (props: CampaignSettingsSigilRowProps) => {
...
export default CampaignSettingsSigilRow;

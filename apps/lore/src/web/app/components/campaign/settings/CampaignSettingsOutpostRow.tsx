...
export interface CampaignSettingsOutpostRowProps {
 ...
 */
const CampaignSettingsOutpostRow = (props: CampaignSettingsOutpostRowProps) => {
...
export default CampaignSettingsOutpostRow;

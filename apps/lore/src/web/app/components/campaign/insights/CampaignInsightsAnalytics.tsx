...
export interface CampaignInsightsAnalyticsProps {
 ...
 */
const CampaignInsightsAnalytics = (props: CampaignInsightsAnalyticsProps) => {
...
export default CampaignInsightsAnalytics;

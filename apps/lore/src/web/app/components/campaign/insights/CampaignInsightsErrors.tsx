...
export interface CampaignInsightsErrorsProps {
 ...
 * Blights inbox folds staging and production into one row per campaign on
 ...
 */
const CampaignInsightsErrors = (props: CampaignInsightsErrorsProps) => {
...
export default CampaignInsightsErrors;

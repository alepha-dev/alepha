...
export interface CampaignChaptersCloseModalProps {
  chapter: ChapterWithCount;
  onConfirm: (title: string) => void;
  onCancel: () => void;
}

const CampaignChaptersCloseModal = (props: CampaignChaptersCloseModalProps) => {
...
export default CampaignChaptersCloseModal;

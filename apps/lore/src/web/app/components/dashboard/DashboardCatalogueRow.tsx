...
const DashboardCatalogueRow = (props: DashboardCatalogueRowProps) => {
  ...
  return (
    <button
      ...
      className="border-border hover:border-border-hover flex items-center gap-2.5 rounded-[9px] border px-2.5 py-2.5 text-left transition-colors disabled:cursor-not-allowed disabled:opacity-50"
    >

    ...
    lazy: async () => ({
      default: {
        ...
        "blights.deleteSelectedConfirm":
          "Delete $1 selected blights permanently?",
        ...
        "sigils.dialog.editDescription":
          "Update the label, excluded paths and capabilities. The sigil id is unchanged.",
  ...
  fr = $dictionary({
    lazy: async () => ({
      default: {
        ...
        "sigils.dialog.editDescription":
          "Modifiez le libellé, les chemins exclus et les capacités. L'id du sigil reste inchangé.",

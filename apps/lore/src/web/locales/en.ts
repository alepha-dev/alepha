export default {
  ...
  "milestone.banner.active": "Active Milestone",
  "milestone.list.quests": "$1 quest(s)",
  "milestone.list.closed": "Closed $1",
  "milestone.list.closesIn": "Closes $1",
  "milestone.tags": "Tags",
  ...
  "milestone.page.eyebrow": "The Tome",
  "milestone.page.title": "Milestones",
  "milestone.page.subtitle":
    "Each milestone is a release in your saga. Start one, gather quests, then seal it to forge a permanent changelog.",
  "milestone.hero.eyebrow": "Milestone $1 · Now playing",
  "milestone.hero.empty.title": "No active milestone",
  "milestone.hero.empty.subtitle":
    "Open a new milestone to start recording what your party accomplishes — every completed quest will be sealed into its changelog when you close it.",
  "milestone.hero.stat.quests": "Quests",
  "milestone.hero.stat.tags": "Tags",
  "milestone.hero.stat.started": "Started",
  "milestone.hero.stat.closesIn": "Closes",
  "milestone.hero.progress": "Time spent",
  "milestone.stats.milestones": "Milestones",
  "milestone.stats.quests": "Quests recorded",
  "milestone.stats.tags": "Unique tags",
  "milestone.history.title": "History",
  "milestone.history.empty":
    "No closed milestones yet. Once you seal a milestone, it will appear here as a permanent record.",
  "milestone.row.startedNow": "Started $1",

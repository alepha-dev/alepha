export default {
  ...
  "home.greeting": "What's the next quest?",
  "home.search.placeholder": "Search quests, folios and projects",
  ...
  "quest.create.submit": "Create quest",
  "quest.create.submitAndAccept": "Create and accept",
  ...
  "reports.quests.status.todo": "To do",
  "reports.quests.status.inProgress": "In progress",
  ...
  "project.settings.kanban.columns.status.todo": "To do",
  "project.settings.kanban.columns.status.inProgress": "In progress",
  ...
  "apps.table.lastSeen": "Last seen",
  "apps.table.estate": "Deploys to",
  "apps.table.created": "Created",
  ...
  "app.environment.description":
    "What this copy runs with. A variable (declared `secret: false` by the app) shows its value; a secret is encrypted and never shown again - replace one rather than read it. DATABASE_URL, R2_BUCKET_NAME and the CLOUDFLARE_* names are set by the deploy itself.",
  ...
  "app.environment.add.description":
    "Pick a name the app declares, or type any other. Setting a name that already exists replaces its value.",
  "app.environment.key": "Name",
  "app.environment.value": "Value",
  "app.environment.save": "Save",
  "app.environment.saved": "Variable saved",
  "app.environment.kind": "Kind",
  "app.environment.kind.secret": "Secret",
  "app.environment.kind.variable": "Variable",
  "app.environment.updated": "Updated",
  "app.environment.edit": "Edit",
  "app.environment.edit.title": "Edit $1",
  "app.environment.replace": "Replace",
  "app.environment.replace.title": "Replace $1",
  "app.environment.replace.description":
    "A secret is never shown again. Enter its new value.",
  "app.environment.value.required": "Enter a value.",
  "app.environment.import": "Import .env",
  "app.environment.import.title": "Import a .env",
  "app.environment.import.description":
    "Paste a .env, or drop the file onto the field. Nothing is saved until you import.",
  "app.environment.import.new": "New",
  "app.environment.import.replaced": "Replaced",
  "app.environment.import.refused": "Refused",
  "app.environment.import.line": "line $1",
  "app.environment.import.invalidName": "not a variable name",
  "app.environment.import.emptyValue": "empty value",
  "app.environment.import.reserved": "set by the deploy",
  "app.environment.import.duplicate": "repeated, the last value wins",
  "app.environment.import.unterminated": "unterminated quote",
  "app.environment.import.syntax": "not KEY=value",
  "app.environment.import.cancel": "Cancel",
  "app.environment.import.submit": "Import $1",
  "app.environment.import.done": "$1 imported",
  ...
  "insights.audience.user": "Signed in",
  "insights.audience.anon": "Signed out",
  ...
  "bay.overview.reported": "reported $1",
  "bay.overview.noReportYet": "connected, nothing reported yet",
  "bay.overview.neverConnected": "this machine has never connected",
  "bay.overview.memory": "Memory",
  "bay.overview.disk": "Disk",
  "bay.overview.cpu": "CPU",
  "bay.overview.cores": "Cores",
  "bay.overview.load": "Load (1m)",
  "bay.overview.uptime": "Up since",
  "bay.overview.connection": "Connection",
  "bay.overview.state": "State",
  "bay.overview.lastSeen": "Last seen",
  "bay.overview.connectedSince": "Connected since",
  "bay.overview.interval": "Reports every",
  "bay.overview.intervalValue": "$1s",
  "bay.overview.version": "Bay $1",
  "bay.overview.versionUnknown": "Bay version not reported",
  "bay.state.static": "static",
  "bay.state.running": "running",
  "bay.state.stopped": "stopped",
  "bay.state.crashed": "crashed",
  "bay.state.restarting": "restarting",
  "bay.state.down": "not running",
  "bay.state.missing": "not reported",
  "bay.apps.empty": "This machine runs nothing",
  ...
  "bay.apps.col.release": "Release",
  "bay.apps.col.memory": "Memory",
  "bay.apps.col.restarts": "Restarts",
  "bay.apps.col.uptime": "Started",
  "bay.apps.col.lastRequest": "Last request",
  "bay.apps.col.backup": "Backup",
  "bay.apps.col.problems": "Bay reports",
  "bay.apps.untracked": "not in Lore",
  "bay.apps.missing": "expected here, not running",
  "bay.apps.cronsOnly": "$1 cron(s), no requests",
  ...
  "bay.commands.empty": "Nothing has been asked of this machine",
  "bay.commands.empty.description":
    "Restarts, stops, backups and deploys appear here with what became of them.",
  "bay.commands.noMatch": "No command matches",
  ...
  "bay.settings.loans.col.project": "Project",
  "bay.settings.loans.col.lentAt": "Lent",
  ...
  // about one rather than standing the project title in its place.
  "agentPrompts.copied.surface":
    "Prompt copied. Paste it into Claude Code or Codex.",
  ...
  "dashboard.metric.activeQuests.hint": "to do + in progress, project or all",
  ...
  "dashboard.filter.todoInProgress": "to do + in progress",
  ...
  "dashboard.filterValue.todo": "To do",
  "dashboard.filterValue.in_progress": "In progress",
  ...
  "dashboard.footer.questSplit": "$1 in progress, $2 to do",
  ...
  "permission.artifact.push": "Push a build",
  ...
  "permission.quality.push": "Record coverage and test totals",

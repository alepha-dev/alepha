export default {
  ...
  "spotlight.hint":
    "Saisissez pour rechercher quêtes et folios, ou un numéro comme #E12.",
  ...
  "spotlight.group.epics": "Épopées",
  "spotlight.group.releases": "Versions",
  "spotlight.group.feedback": "Retours",
  ...
  "home.greeting": "Quelle est la prochaine quête ?",
  "home.search.placeholder": "Rechercher des quêtes, des folios et des projets",
  "home.search.searching": "Recherche...",
  "home.search.empty": "Aucun résultat",
  "home.search.projects": "Projets",
  "home.search.navigate": "pour naviguer",
  "home.search.select": "pour ouvrir",
  "home.recent.title": "Projets récents",
  "home.recent.showMore": "Afficher plus",
  "home.table.owner": "Vous êtes propriétaire de ce projet",
  "home.table.momentum.label": "$1 événements sur les $2 derniers jours",
  "home.table.momentum.event": "événement",
  "home.table.momentum.events": "événements",
  "home.table.momentum.delta": "$1 %",
  "home.table.momentum.delta.hint":
    "Les 7 derniers jours comparés aux 7 précédents",
  "home.table.momentum.flat": "stable",
  "home.table.open.quests": "$1 quêtes ouvertes",
  ...
  "folios.editor.tree.collapse": "Replier l\u2019arborescence",
  "folios.editor.tree.expand": "Afficher l\u2019arborescence",
  ...
  "quest.create.submit": "Créer la quête",
  "quest.create.submitAndAccept": "Créer et accepter",
  ...
  "board.bulk.shelve.none":
    "Aucune des quêtes sélectionnées ne peut être mise de côté : seule une quête encore à faire le peut.",
  "board.bulk.shelve.skipped":
    "$1 ignorée(s) : seule une quête encore à faire peut être mise de côté.",
  ...
  "quest.status.onHold": "En attente",
  ...
  "reports.quests.status.todo": "À faire",
  "reports.quests.status.inProgress": "En cours",
  ...
  "project.settings.kanban.columns.status.todo": "À faire",
  "project.settings.kanban.columns.status.inProgress": "En cours",
  ...
  "release.artifacts.column.format": "Format",
  "release.artifacts.column.runtime": "Runtime",
  ...
  "apps.table.lastSeen": "Vue pour la dernière fois",
  "apps.table.estate": "Déploie sur",
  "apps.table.created": "Créée",
  ...
  "app.environment.description":
    "Ce avec quoi cette copie tourne. Une variable (déclarée `secret: false` par l'app) affiche sa valeur ; un secret est chiffré et n'est plus jamais affiché - remplacez-le plutôt que de le lire. DATABASE_URL, R2_BUCKET_NAME et les noms CLOUDFLARE_* sont définis par le déploiement lui-même.",
  ...
  "app.environment.add.description":
    "Choisissez un nom déclaré par l'app, ou tapez-en un autre. Définir un nom existant remplace sa valeur.",
  ...
  "app.environment.kind": "Type",
  "app.environment.kind.secret": "Secret",
  "app.environment.kind.variable": "Variable",
  "app.environment.updated": "Modifié",
  "app.environment.edit": "Modifier",
  "app.environment.edit.title": "Modifier $1",
  "app.environment.replace": "Remplacer",
  "app.environment.replace.title": "Remplacer $1",
  "app.environment.replace.description":
    "Un secret n'est plus jamais affiché. Saisissez sa nouvelle valeur.",
  "app.environment.value.required": "Saisissez une valeur.",
  "app.environment.import": "Importer un .env",
  "app.environment.import.title": "Importer un .env",
  "app.environment.import.description":
    "Collez un .env, ou déposez le fichier sur le champ. Rien n'est enregistré avant l'import.",
  "app.environment.import.new": "Nouveau",
  "app.environment.import.replaced": "Remplacé",
  "app.environment.import.refused": "Refusé",
  "app.environment.import.line": "ligne $1",
  "app.environment.import.invalidName": "nom de variable invalide",
  "app.environment.import.emptyValue": "valeur vide",
  "app.environment.import.reserved": "défini par le déploiement",
  "app.environment.import.duplicate": "répété, la dernière valeur l'emporte",
  "app.environment.import.unterminated": "guillemet non fermé",
  "app.environment.import.syntax": "pas de la forme CLÉ=valeur",
  "app.environment.import.cancel": "Annuler",
  "app.environment.import.submit": "Importer $1",
  "app.environment.import.done": "$1 importés",
  ...
  "insights.filter.auth": "Audience",
  "insights.topAudience": "Audience",
  "insights.audience.user": "Connectés",
  "insights.audience.anon": "Non connectés",
  ...
  "bay.nav.overview": "Vue d'ensemble",
  ...
  "bay.overview.reported": "communiqué $1",
  "bay.overview.noReportYet": "connectée, rien de communiqué pour l'instant",
  "bay.overview.neverConnected": "cette machine ne s'est jamais connectée",
  "bay.overview.memory": "Mémoire",
  "bay.overview.disk": "Disque",
  "bay.overview.cpu": "Processeur",
  "bay.overview.cores": "Cœurs",
  "bay.overview.load": "Charge (1 min)",
  "bay.overview.uptime": "Démarrée",
  "bay.overview.connection": "Connexion",
  "bay.overview.state": "État",
  "bay.overview.lastSeen": "Vue",
  "bay.overview.connectedSince": "Connectée depuis",
  "bay.overview.interval": "Communique toutes les",
  "bay.overview.intervalValue": "$1 s",
  "bay.overview.version": "Bay $1",
  "bay.overview.versionUnknown": "Version de Bay non communiquée",
  "bay.state.static": "statique",
  "bay.state.running": "en marche",
  "bay.state.stopped": "arrêtée",
  "bay.state.crashed": "plantée",
  "bay.state.restarting": "redémarrage",
  "bay.state.down": "à l'arrêt",
  "bay.state.missing": "non communiquée",
  "bay.apps.empty": "Cette machine n'exécute rien",
  "bay.apps.empty.description":
  ...
  "bay.apps.col.release": "Version",
  "bay.apps.col.memory": "Mémoire",
  "bay.apps.col.restarts": "Redémarrages",
  "bay.apps.col.uptime": "Démarrée",
  "bay.apps.col.lastRequest": "Dernière requête",
  "bay.apps.col.backup": "Sauvegarde",
  "bay.apps.col.problems": "Rapport de Bay",
  "bay.apps.untracked": "absente de Lore",
  "bay.apps.missing": "attendue ici, non démarrée",
  "bay.apps.cronsOnly": "$1 tâche(s) planifiée(s), aucune requête",
  ...
  "bay.commands.empty": "Rien n'a été demandé à cette machine",
  "bay.commands.empty.description":
    "Les redémarrages, arrêts, sauvegardes et déploiements apparaissent ici avec leur issue.",
  "bay.commands.noMatch": "Aucune commande ne correspond",
  ...
  "bay.settings.loans.col.project": "Projet",
  "bay.settings.loans.col.lentAt": "Prêté",
  ...
  "dashboard.filter.todoInProgress": "à faire + en cours",
  "dashboard.filter.todo": "à faire",
  ...
  "dashboard.filterValue.todo": "À faire",
  "dashboard.filterValue.in_progress": "En cours",
  ...
  "dashboard.footer.questSplit": "$1 en cours, $2 à faire",
  ...
  "permission.artifact.push": "Publier un build",
  ...
  "permission.quality.push": "Enregistrer la couverture et les totaux de tests",

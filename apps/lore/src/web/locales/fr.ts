export default {
  ...
  "milestone.banner.active": "Jalon actif",
  "milestone.list.quests": "$1 quête(s)",
  "milestone.list.closed": "Clos le $1",
  "milestone.list.closesIn": "Clôture $1",
  ...
  "milestone.page.eyebrow": "Le Tome",
  "milestone.page.title": "Jalons",
  "milestone.page.subtitle":
    "Chaque jalon est une release de votre saga. Ouvrez-en un, accumulez les quêtes, puis scellez-le pour figer son changelog.",
  "milestone.hero.eyebrow": "Jalon $1 · En cours",
  "milestone.hero.empty.title": "Aucun jalon actif",
  "milestone.hero.empty.subtitle":
    "Ouvrez un nouveau jalon pour commencer à consigner les exploits de votre équipée — chaque quête accomplie sera scellée dans le changelog à la clôture.",
  "milestone.hero.stat.quests": "Quêtes",
  "milestone.hero.stat.tags": "Étiquettes",
  "milestone.hero.stat.started": "Ouvert",
  "milestone.hero.stat.closesIn": "Clôture",
  "milestone.hero.progress": "Temps écoulé",
  "milestone.stats.milestones": "Jalons",
  "milestone.stats.quests": "Quêtes enregistrées",
  "milestone.stats.tags": "Étiquettes uniques",
  "milestone.history.title": "Historique",
  "milestone.history.empty":
    "Aucun jalon clôturé. Une fois scellés, vos jalons apparaîtront ici comme un témoignage permanent.",
  "milestone.row.startedNow": "Ouvert $1",

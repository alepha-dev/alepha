 ...
 * epic) plus `blob`, a binary attachment.
 *
 ...
 * The literals ARE the stored values: renaming one is a data migration, not
 * a rename.
 */
export const linkTargetKindSchema = z.enum(["folio", "quest", "epic", "blob"]);

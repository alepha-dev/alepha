...
/**
 * One area's worth of a milestone changelog, in structured form.
 *
 ...
 * milestone. These areas are recomputed on read, so a quest edited after the
 * close will show a different title here than in the downloadable `.md`.
 */
export const milestoneChangelogAreaSchema = z.object({
  /**
...
export type MilestoneChangelogArea = Infer<typeof milestoneChangelogAreaSchema>;

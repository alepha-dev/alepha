...
- `maxFeedbackPerSigilPerDay: 50` — meant to cap the blast radius of a leaked sigil token; declared on the atom but not enforced yet (nothing reads it, and `feedback.source.sigilId` is never written).

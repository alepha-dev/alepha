...
| `/:projectSlug/apps/:app/:env/errors`                        | `appErrors`                | `project/apps/AppErrors.tsx`                  | This instance's error groups, from `sigil_error_groups`. Unlocked by `blights` rather than `beacon` - the two kinds are genuinely independent, and an instance can carry either without the other                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

...
import { HttpClient, ServerProvider } from "../src";
...
test("ServerRouterProvider - Verify raw HTTP error response includes requestId", async ({
	expect,
}) => {
...
test("ServerRouterProvider - Verify raw HTTP error response for generic error includes requestId", async ({
	expect,
}) => {
	// Make raw HTTP request to see the actual JSON response
...
test("ServerRouterProvider - Auto-generated requestId in raw response", async ({
	expect,
}) => {
...
test("ServerRouterProvider - HttpClient properly handles error with requestId", async ({
	expect,
}) => {
	try {

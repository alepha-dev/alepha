...
import { telemetryEnvelope } from "../shared/schemas/telemetryEnvelope.ts";
 ...
 *
 * `POST /api/telemetry/ingest` — views, errors, vitals.
 *
 ...
 * no such id any more.
 */
export class TelemetryProxyController {
  protected readonly sink = $inject(TelemetrySinkProvider);

...
/**
 * Context exemption: the parts of ONE drawer share its state. Two drawers on
 * a page need two values, and an `$atom` holds one per container.
 */
...
export type DrawerSwipeHandleProps = React.ComponentProps<"div">;

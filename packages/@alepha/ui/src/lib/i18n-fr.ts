...
export const uiFr: Record<string, string> = {
  ...
  "admin.notifications.colReason": "Motif",
  "admin.notifications.colRecipient": "Destinataire",
  "admin.notifications.colSince": "Depuis",
  ...
  "admin.notifications.lift": "Reprendre l'envoi",
  "admin.notifications.liftConfirm":
    "Reprendre les envois vers $1 ? Ce contact s'est désabonné, a rebondi ou s'est plaint.",
  "admin.notifications.liftTitle": "Reprendre l'envoi",
  "admin.notifications.lifted": "Blocage levé",

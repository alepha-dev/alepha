...
export const uiFr: Record<string, string> = {
  ...
  "admin.workflows.status.cancelled": "Annulé",
  "admin.workflows.status.compensated": "Compensé",
  "admin.workflows.status.compensating": "Compensation en cours",
  "admin.workflows.status.compensationFailed": "Échec de la compensation",
  "admin.workflows.status.completed": "Terminé",
  "admin.workflows.status.failed": "Échec",
  "admin.workflows.status.pending": "En attente",
  "admin.workflows.status.running": "En cours",
  "admin.workflows.status.skipped": "Ignoré",
  "admin.workflows.status.timedOut": "Délai dépassé",

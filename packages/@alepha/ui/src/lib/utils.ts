/**
 * `cn` is a zero-dependency engine for Tailwind class merging: the same API
 * and output as `clsx` + `tailwind-merge`. This module is the one import path
 * for it across the package, primitives and blocks alike.
 */
export { cn } from "cn";

...
export const uiFr: Record<string, string> = {
  ...
  "account.keys.colCreated": "Créée",
  "account.keys.colExpires": "Expire",
  "account.keys.colIpAllowlist": "Autorisée depuis",
  "account.keys.colLastUsed": "Dernière utilisation",
  "account.keys.colName": "Nom",
  "account.keys.colScope": "Portée",
  "account.keys.colStatus": "Statut",
  "account.keys.colToken": "Jeton",
  "account.keys.ipAnywhere": "Partout",
  "account.keys.never": "Jamais",
  "account.keys.statusAll": "Tous les statuts",

...
export const uiFr: Record<string, string> = {
  ...
  "admin.files.statBuckets": "Buckets",
  "admin.files.statBucketsHint": "Le plus gros : $1",
  "admin.files.statFiles": "Fichiers",
  "admin.files.statStorage": "Espace utilisé",
  "admin.files.statStorageHint": "$1 par fichier en moyenne",
  "admin.files.statTypes": "Types de fichiers",
  "admin.files.statTypesHint": "Surtout $1",

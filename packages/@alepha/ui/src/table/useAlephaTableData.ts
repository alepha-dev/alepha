...
/**
 * The rows `AlephaTable` renders and the state that picks them: the page, the
 ...
 * and the scope change in `AlephaTable` write the same state.
 */
export const useAlephaTableData = <T>(
  options: UseAlephaTableDataOptions<T>,
) => {

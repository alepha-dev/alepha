...
import { AlephaTableBody } from "./AlephaTableBody.tsx";
import { AlephaTableBulkBar } from "./AlephaTableBulkBar.tsx";
import { AlephaTableFooter } from "./AlephaTableFooter.tsx";
import { AlephaTableHeaderRow } from "./AlephaTableHeaderRow.tsx";
import {
  persistedColumns,
  persistedOrder,
  persistedSize,
...
export const AlephaTable = <T,>(props: AlephaTableProps<T>) => {
   ...
   * The sort effect (`useAlephaTableData`) and the column writes
   * (`useAlephaTableColumns`) are keyed on `persistenceKey` too, so on the

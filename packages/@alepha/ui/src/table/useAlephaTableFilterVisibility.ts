...
export interface UseAlephaTableFilterVisibilityOptions {
  /**
 ...
 */
export const useAlephaTableFilterVisibility = (
  options: UseAlephaTableFilterVisibilityOptions,
) => {
   ...
   * `AlephaTable`'s render-time scope block, with the other facets, and for

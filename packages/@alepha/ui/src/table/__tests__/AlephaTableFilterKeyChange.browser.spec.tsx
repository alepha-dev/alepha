 ...
 */
describe("AlephaTable (filter keys changed after mount)", () => {
  ...
  const table = (fields: AlephaTableFilterFields) => (
    <AlephaTable<Row, AlephaTableFilterFields>
      data={rows}
      columns={columns}
  ...
  const mount = async (fields: AlephaTableFilterFields) => {

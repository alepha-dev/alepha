...
import type { BulkAction, BulkMenuAction } from "../dataTableTypes.ts";
 ...
 */
describe("DataTable (bulk menu action)", () => {
  ...
  const mount = async (action: BulkMenuAction<Row>) => {
    ...
    const view = render(
      <AlephaContext.Provider value={alepha}>
        <DataTable<Row> data={rows} columns={columns} bulkActions={[action]} />
